...
create_generated_clock -name clk25mhz -source [get_ports {CLK100MHZ}] -divide_by 4 [get_pins top/CLK25MHZ]

##Switches
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { i1 }]; #IO_L24N_T3_RS0_15 Sch=sw[0]
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { i2 }]; #IO_L3N_T0_DQS_EMCCLK_14 Sch=sw[1]
